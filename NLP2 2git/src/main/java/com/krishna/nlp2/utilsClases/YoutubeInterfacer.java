...
public class YoutubeInterfacer {
    /** Global instance properties filename. */
    private static String PROPERTIES_FILENAME = "cred.properties";
     ...
     */
    public static List<SearchResult> getVideos(String term) {
        ...
        try {
             ...
             */
            youtube = new YouTube.Builder(HTTP_TRANSPORT, JSON_FACTORY, (HttpRequestInitializer) request -> {}).setApplicationName("youtube-cmdline-search-sample").build();
